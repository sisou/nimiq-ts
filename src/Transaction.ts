...
abstract class Transaction {
    ...
    constructor(
        ...
        if (!NumberUtils.isUint64(value) || (value === 0 && (flags & Transaction.Flag.SIGNALLING) === 0)) throw new Error('Malformed value');
    ...
    get isSignalling(): boolean {
        return this.hasFlag(Transaction.Flag.SIGNALLING);
    }
